...
const attrs = ['id', 'description', 'priceEUR', 'priceGBP', 'priceUSD', 'salePercentage', 'releaseId', 'shopId', 'status', 'shipping', 'offerDate', 'raffle', 'raffleStart', 'raffleEnd', 'displayWhatsNew', 'displayOnSale', 'createdAt', 'updatedAt']
