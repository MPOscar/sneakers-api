...
const attrs = ['id', 'priceEUR', 'priceGBP', 'priceUSD', 'salePercentage', 'releaseId', 'status', 'shipping', 'offerDate', 'raffle', 'raffleStart', 'raffleEnd', 'releaseTime', 'displayWhatsNew', 'displayOnSale', 'createdAt', 'updatedAt']
